...
export const calcScore = (score, board) => {
...
export const setupBoard = () => {
  let board = repeat(null, 16).map((x, idx) => {
...
export const calcNewPositions = (board, direction) => {
...
export const assignNewRandom = board => {
...
export const getSteps = (direction, entry) => {
  let steps = ''
