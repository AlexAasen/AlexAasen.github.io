...
export function renderCircleShadows({ svg, innerRadius, circleWidth, circles, oneDegreeSpan }){
...
export function renderCircleLines({ svg, circles, innerRadius, circleWidth, oneDegreeSpan }){
...
export function renderData({ svg, dataset, circleWidth, innerRadius, oneDegreeSpan, angleVariable }){
  const pie = d3.pie()
      .value(d => d.color)
...
export function renderAxises({ svg, angles, circleWidth, innerRadius, hours, angleVariable }){
...
export function renderDegreeLabels({ svg, angleVariable, angles, circleWidth, innerRadius, hours }){
...
export function renderWindAngles({ svg, innerRadius, circleWidth, hours, angleVariable, weatherDirections }){
