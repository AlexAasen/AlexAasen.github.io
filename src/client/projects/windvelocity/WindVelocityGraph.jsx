...
import { mathRadians, getRandom } from 'utils/helpers'
import { renderCircleShadows,
  renderCircleLines,
  renderData,
  renderAxises,
  renderDegreeLabels,
  renderWindAngles } from './windVelocityRender'
          ...
          <div className="wind-velocity-container" ref="wind-velocity-container">
            ...
            <div className="graph-labels">
              ...
              <div className="button-holder">
                <Button className="generate-button" onClick={() => this.setState({ dataset: this.generateDataset() })}>
                  Generate new data
                </Button>
              </div>
            </div>
